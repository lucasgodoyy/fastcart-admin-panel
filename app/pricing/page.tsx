...
const PLANS = [
  ...
  },
  {
    id: 'starter',
    name: 'Starter',
    description: 'Para quem está começando e quer vender mais.',
    icon: Rocket,
    monthlyPrice: 49,
    annualPrice: 470,
    maxProducts: 500,
    ...
    trialDays: 14,
    isPopular: false,
    ctaLabel: 'Iniciar 14 dias grátis',
    features: [
      '1 loja',
      'Até 500 produtos',
      'Domínio próprio',
  ...
  },
  {
    id: 'plus',
    name: 'Plus',
    description: 'Para lojas em crescimento com recursos avançados.',
    icon: Crown,
    monthlyPrice: 99,
    annualPrice: 950,
    maxProducts: 5000,
  ...
  },
  {
    id: 'pro',
    name: 'Pro',
    description: 'Para operações de alto volume com suporte dedicado.',
    icon: Gem,
    monthlyPrice: 149,
    annualPrice: 1430,
    maxProducts: null,
    ...
    trialDays: 30,
    isPopular: false,
    ctaLabel: 'Iniciar 30 dias grátis',
    features: [
      'Lojas ilimitadas',
      'Produtos ilimitados',
      'Tudo do Plus',
...
const COMPARISON = [
  {
    category: 'Loja',
    rows: [
      { label: 'Número de lojas', values: ['1', '1', '2', 'Ilimitado'] },
  ...
  },
  {
    category: 'Pagamentos',
    rows: [
      { label: 'Checkout básico', values: [true, true, true, true] },
      { label: 'Boleto Bancário', values: [false, true, true, true] },
      { label: 'Mercado Pago', values: [false, true, true, true] },
      { label: 'PIX automático', values: [false, false, true, true] },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Cupons & promoções', values: [false, false, true, true] },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-4xl px-6 pt-16 pb-8 text-center">
        ...
        <p className="mx-auto mt-4 max-w-xl text-base text-muted-foreground">
          Comece grátis, faça upgrade quando precisar. Sem taxa de setup, cancele quando quiser.
        </p>
          ...
          {PLANS.map((plan) => {
            ...
            return (
              ...
              >
                ...
                {plan.trialDays > 0 && (
                  <p className="mt-1 text-xs text-blue-600">? {plan.trialDays} dias grátis</p>
                )}
                ...
                <div className="mb-4 space-y-0.5 text-[11px] text-muted-foreground">
                  ...
                  <p>
                    {plan.maxStaff == null ? '8 membros' : `Até ${plan.maxStaff} membros`}
                  </p>
                  <p>
                    {plan.maxStores == null ? '8 lojas' : `Até ${plan.maxStores} loja${plan.maxStores > 1 ? 's' : ''}`}
                  </p>
                </div>
      ...
      <section className="border-t border-border bg-muted/30 py-16">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            Crie sua loja hoje, de graça. Não precisamos de cartão de crédito.
          </p>
