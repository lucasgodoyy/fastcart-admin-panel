    ...
    <aside className="hidden lg:flex h-full w-60 flex-col bg-sidebar-bg overflow-y-auto shrink-0 border-r">
      ...
      <div className="flex items-center gap-2.5 px-5 py-5">
        ...
        <div className="min-w-0">
          ...
          <span className="text-[10px] text-sidebar-muted font-medium">Painel Gerente</span>
        </div>
      </div>
      ...
      <div className="mx-3 mb-4 rounded-lg bg-sidebar-accent/50 px-3 py-2.5">
        ...
        <p className="text-[10px] text-sidebar-muted">Gerente</p>
      </div>
      ...
      <div className="border-t border-sidebar-border px-3 py-3">
        <div className="rounded-lg bg-primary/5 px-3 py-3 text-center">
          <p className="text-[11px] font-semibold text-primary">Acesso Gerente</p>
          <p className="text-[10px] text-muted-foreground mt-0.5">Visão operacional da plataforma</p>
        </div>
      </div>
    </aside>
  );
