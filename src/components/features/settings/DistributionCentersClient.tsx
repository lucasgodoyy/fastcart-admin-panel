...
export function DistributionCentersClient() {
  ...
  return (
    <SettingsPageLayout
      title="Definir centro de distribuicao principal"
      description="Sera usado como o principal local de envio ou armazenamento dos produtos da loja."
      helpText="Mais sobre centros de distribuicao"
      helpHref="#"
    >
      <div className="rounded-lg border border-border bg-card p-5 space-y-4">
        ...
        <div className="pt-2">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            O estoque deste centro estara disponivel para todas as vendas
          </p>
        </div>
      </div>
