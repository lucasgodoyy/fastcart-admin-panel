...
export function ShippingMethodsClient() {
  return (
    <SettingsPageLayout
      ...
      helpText="Mais sobre meios de envio"
      helpHref="#"
    >
      {/* Tabs */}
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <ul className="mt-1.5 space-y-1 text-xs text-muted-foreground">
              ...
              <li>Fretes ate 30% mais baratos.</li>
              <li>Emissao de etiquetas integrada as suas vendas.</li>
              <li>Envio automatico de codigos de rastreio.</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      {/* Custo e prazo padrao */}
      <div className="rounded-lg border border-border bg-card p-5">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-sm font-medium text-foreground">Custo e prazo de entrega padrao</p>
            <p className="mt-1 text-xs text-muted-foreground">
              Defina um custo e prazo de entrega fixos para quando os meios de envio estiverem fora de servico.
            </p>
            <div className="mt-2 flex gap-4 text-xs text-muted-foreground">
              <span>Custo: R$ 20</span>
              <span>Prazo: 10 dias uteis</span>
            </div>
          </div>
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 flex items-start gap-3">
        ...
        <p className="text-xs text-blue-700">
          Voce sabia que tambem pode enviar seus pedidos personalizados por Nuvem Envio e centralizar tudo em um so lugar?{' '}
