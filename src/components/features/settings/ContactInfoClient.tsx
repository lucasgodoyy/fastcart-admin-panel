...
export function ContactInfoClient() {
  ...
  return (
    <SettingsPageLayout
      ...
      helpText="Mais sobre informacao de contato"
      helpHref="#"
    >
      <div className="rounded-lg border border-border bg-card p-5 space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground">
            Pode ser diferente do e-mail que voce usa para acessar seu painel administrador.
          </p>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            placeholder="Informacao adicional que voce queira exibir no formulario de contato."
          />
        </div>
      </div>
